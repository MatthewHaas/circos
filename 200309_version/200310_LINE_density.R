...
# This particular script is for long interspersed nuclear elements (LINEs)

# Load required packages
library(data.table)

# Load data and give meaningful names
LINEs <- fread("LINEs.bed")
setnames(LINEs, c("scaffold", "start", "end", "type"))
...
for (i in scaffolds){
LINEs[scaffold==i, .N, key=.(scaffold, bin=start%/%1000000)] -> output
...
myfile <- paste0(i, "_LINEs_binned.txt")

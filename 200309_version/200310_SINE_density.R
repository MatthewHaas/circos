...
# This particular script is for short interspersed nuclear elements (SINEs)

# Load required packages
library(data.table)

# Load data and give meaningful names
SINEs <- fread("SINEs.bed")
setnames(SINEs, c("scaffold", "start", "end", "type"))
...
for (i in scaffolds){
SINEs[scaffold==i, .N, key=.(scaffold, bin=start%/%1000000)] -> output
...
myfile <- paste0(i, "_SINEs_binned.txt")
